...
export async function getPackages(): Promise<Package[]> {
  try {
    ...
    return data.map(pkg => ({
      ...
      estimatedDelivery: pkg.arrival_date && pkg.arrival_date !== '' ? new Date(pkg.arrival_date) : undefined,
      ...
      departureDate: pkg.departure_date && pkg.departure_date !== '' ? new Date(pkg.departure_date) : undefined,
      arrivalDate: pkg.arrival_date && pkg.arrival_date !== '' ? new Date(pkg.arrival_date) : undefined,
  ...
  try {
    ...
    const { error } = await supabase
      ...
      .insert({
        ...
        departure_date: packageData.departureDate ? packageData.departureDate.toISOString() : null,
        arrival_date: packageData.arrivalDate ? packageData.arrivalDate.toISOString() : null,
